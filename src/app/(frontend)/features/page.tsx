...
const features = [
  {
    ...
    description: 'Our advanced neural networks are trained on millions of images to handle complex details like hair, fur, and transparent objects with pixel-perfect accuracy.',
    icon: <Sparkles className="size-6" />,
  },
  {
    title: 'Instant Processing',
    description: 'Remove backgrounds in less than 5 seconds. Our optimized infrastructure ensures you spend less time waiting and more time creating.',
    icon: <Zap className="size-6" />,
  },
  {
    title: 'High-Resolution Export',
    description: 'Download your processed images in full resolution. No quality loss, perfect for professional printing, e-commerce, and high-end design.',
    icon: <Download className="size-6" />,
  },
  {
    title: 'Bulk Processing',
    description: 'Need to process hundreds of images? Our pro tools allow for seamless batch background removal to supercharge your workflow.',
    icon: <Layers className="size-6" />,
  },
  {
    title: 'Smart Edge Detection',
    description: 'Say goodbye to jagged edges. Our AI automatically smooths and refines the boundaries of your subjects for a natural look.',
    icon: <ImageIcon className="size-6" />,
  },
  {
    title: 'Secure & Private',
    description: 'Your data is safe with us. We use enterprise-grade encryption and automatically delete processed files after 24 hours.',
    ...
    <div className="container py-16 sm:py-24">
      <div className="text-center max-w-3xl mx-auto mb-20">
        ...
        <p className="text-xl text-muted-foreground leading-relaxed">
          Everything you need to remove backgrounds and edit images like a pro, 
      ...
      <div className="mt-24 p-12 bg-primary rounded-[3rem] text-primary-foreground text-center overflow-hidden relative">
        ...
        <div className="relative z-10 max-w-2xl mx-auto">
          ...
          <p className="text-lg text-primary-foreground/80 mb-10">
            Join thousands of photographers and designers who are saving hours of manual work every week.
          </p>
          <a 
            href="/upload" 
